...
{
  new (message_memory) mocap_interfaces::msg::Point(_init);
}

void Point_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mocap_interfaces::msg::Point *>(message_memory);
  typed_message->~Point();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point_message_member_array[3] = {
  {
    ...
    offsetof(mocap_interfaces::msg::Point, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_interfaces::msg::Point, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_interfaces::msg::Point, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point_message_members = {
  ...
  "Point",  // message name
  3,  // number of fields
  sizeof(mocap_interfaces::msg::Point),
...
get_message_type_support_handle<mocap_interfaces::msg::Point>()
{
  return &::mocap_interfaces::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap_interfaces, msg, Point)() {
  return &::mocap_interfaces::msg::rosidl_typesupport_introspection_cpp::Point_message_type_support_handle;
}
