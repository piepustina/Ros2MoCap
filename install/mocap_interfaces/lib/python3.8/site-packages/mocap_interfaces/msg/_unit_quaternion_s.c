...
bool mocap_interfaces__msg__unit_quaternion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap_interfaces.msg._unit_quaternion.UnitQuaternion", full_classname_dest, 52) == 0);
  }
  mocap_interfaces__msg__UnitQuaternion * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of UnitQuaternion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap_interfaces.msg._unit_quaternion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UnitQuaternion");
