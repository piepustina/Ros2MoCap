...
static const _RigidBodyArray_type_support_symbol_names_t _RigidBodyArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap_interfaces, msg, RigidBodyArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap_interfaces, msg, RigidBodyArray)),
  }
};
...
{
  return &::mocap_interfaces::msg::rosidl_typesupport_cpp::RigidBodyArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mocap_interfaces, msg, RigidBodyArray)() {
  return get_message_type_support_handle<mocap_interfaces::msg::RigidBodyArray>();
}
