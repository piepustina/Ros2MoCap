...
{
  new (message_memory) mocap_interfaces::msg::RigidBody(_init);
}

void RigidBody_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mocap_interfaces::msg::RigidBody *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RigidBody_message_member_array[5] = {
  {
    ...
    offsetof(mocap_interfaces::msg::RigidBody, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_interfaces::msg::RigidBody, valid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_interfaces::msg::RigidBody, mean_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::mocap_interfaces::msg::rosidl_typesupport_introspection_cpp::RigidBody_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap_interfaces, msg, RigidBody)() {
  return &::mocap_interfaces::msg::rosidl_typesupport_introspection_cpp::RigidBody_message_type_support_handle;
}
