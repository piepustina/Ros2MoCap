...
#include "mocap_interfaces/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mocap_interfaces::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mocap_interfaces::msg::Point *>(
    untyped_ros_message);
...
{
  return &mocap_interfaces::msg::typesupport_fastrtps_cpp::_Point__handle;
}
