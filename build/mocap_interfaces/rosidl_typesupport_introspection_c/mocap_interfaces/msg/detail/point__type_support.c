  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  mocap_interfaces__msg__Point__init(message_memory);
}

void Point__rosidl_typesupport_introspection_c__Point_fini_function(void * message_memory)
{
  mocap_interfaces__msg__Point__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Point__rosidl_typesupport_introspection_c__Point_message_member_array[3] = {
  {
    ...
    offsetof(mocap_interfaces__msg__Point, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_interfaces__msg__Point, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_interfaces__msg__Point, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Point__rosidl_typesupport_introspection_c__Point_message_members = {
  ...
  "Point",  // message name
  3,  // number of fields
  sizeof(mocap_interfaces__msg__Point),
