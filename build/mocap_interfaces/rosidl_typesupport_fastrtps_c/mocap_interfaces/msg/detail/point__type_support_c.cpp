...
#include "mocap_interfaces/msg/detail/point__rosidl_typesupport_fastrtps_c.h"
...
using _Point__ros_msg_type = mocap_interfaces__msg__Point;
...
static uint32_t _Point__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mocap_interfaces__msg__Point(
...
{
  return max_serialized_size_mocap_interfaces__msg__Point(
    full_bounded, 0);
}
